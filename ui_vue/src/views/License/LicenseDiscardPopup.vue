<template>
  <div class="lis_discard_modal">
    <div class="lis_discard_modal-card">
      <h2 class="lis_discard_modal-head">{{ title }}</h2>
      <slot />
      <div class="wrap_cont">
        {{ msg }}
